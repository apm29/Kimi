...
class BaseResp<T>{
  ...
  BaseResp(String data) {
    ...
    switch(T){
      case UserProfile:
        map["data"] = map["data"]==null?null:UserProfile.fromJson(map["data"]);
        break;
      case Login:
        map["data"] = map["data"]==null?null:Login.fromJson(map["data"]);
        break;
      case Applicant:
        map["data"] = map["data"]==null?null:Applicant.fromJson(map["data"]);
    }
    this.data = map["data"];
  }
...
class UserProfile {
  ...
  UserProfile.fromParams({this.is_master, this.is_real, this.type, this.mobile, this.parent_mobile, this.parent_real_name});

  factory UserProfile(jsonStr) => jsonStr is String ? UserProfile.fromJson(json.decode(jsonStr)) : UserProfile.fromJson(jsonStr);
...
class Applicant {
  ...
  Applicant.fromParams({this.vehicle, this.application_id, this.is_editable, this.house, this.job, this.profile});

  factory Applicant(jsonStr) => jsonStr is String ? Applicant.fromJson(json.decode(jsonStr)) : Applicant.fromJson(jsonStr);
...
class Vehicle {
  ...
  Vehicle.fromParams({this.allow_field, this.brand, this.colour, this.id, this.license});
  ...
  @override
  String toString() {
    return '{"allow_field": ${allow_field != null?'${json.encode(allow_field)}':'null'},"brand": ${brand != null?'${json.encode(brand)}':'null'},"colour": ${colour != null?'${json.encode(colour)}':'null'},"id": ${id != null?'${json.encode(id)}':'null'},"license": ${license != null?'${json.encode(license)}':'null'}}';
  }
}
